...
public class MarbMod {
	public static final Logger LOGGER = LogManager.getLogger(MarbMod.class);
	public static final String MODID = "marb";

	public MarbMod(IEventBus modEventBus) {
		...
		MarbModTabs.REGISTRY.register(modEventBus);
